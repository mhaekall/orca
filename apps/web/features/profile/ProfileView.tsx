...
export default function ProfileView() {
  ...
  return (
    <div className="min-h-screen bg-[#13111a] pb-32 pt-[env(safe-area-inset-top)] px-4 md:px-8 max-w-3xl mx-auto space-y-6">
      
      {/* Header Profile Section */}
      <section className="flex flex-col items-center justify-center pt-8 pb-6 border-b border-white/10 relative">
        <div className="relative mb-4 group">
          <div className="w-24 h-24 md:w-28 md:h-28 rounded-full overflow-hidden border-2 border-white/20 shadow-2xl relative z-10 bg-[#1f1c29]">
            <img 
      ...
      {session?.user && (
        <section className="grid grid-cols-2 gap-3 anim-fade">
          <Link href="/notifications" className="flex flex-col items-center justify-center p-4 bg-[#1f1c29] hover:bg-[#2a2536] rounded-2xl border border-white/5 transition-colors group">
          ...
          <div className="flex flex-col items-center justify-center p-4 bg-[#1f1c29] hover:bg-[#2a2536] rounded-2xl border border-white/5 transition-colors cursor-pointer group" onClick={() => alert("Fitur Teman segera hadir!")}>
      ...
      {/* Watch Stats */}
      <section className="bg-[#1f1c29] rounded-[24px] p-5 border border-white/5 anim-fade">
      ...
      <section className="space-y-3 anim-fade">
        ...
        <div className="bg-[#1f1c29] rounded-[24px] border border-white/5 overflow-hidden flex flex-col">

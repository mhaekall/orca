with open("apps/mobile/modules/native-video-player/android/src/main/java/expo/modules/nativevideoplayer/NativeVideoPlayerView.kt", "w") as f:
    f.write("""package expo.modules.nativevideoplayer

...
async def warmup_all_pending():
    ...
    print("==================================================")
    print("🔥 MASS CACHE WARMUP (Scraper Node: Local Termux)")
    print("==================================================")

    # Mencari semua episode ongoing yang belum di-ingest ke Telegram
    query = """
        ...
        WHERE e."episodeUrl" NOT LIKE '%tg-proxy%' 
          ...
          AND e."episodeUrl" != ''
          AND m."cleanTitle" NOT ILIKE '%One Piece%'
    ...
    if not rows:
        print("✅ Tidak ada episode pending yang perlu dipanaskan.")
    ...
    for idx, row in enumerate(rows):
        ...
        # Jeda 3 detik antar request agar IP Termux Anda tidak diblokir/rate-limit oleh provider
        await asyncio.sleep(3)

    print("\\n==================================================")
    print(f"🎉 WARMUP SELESAI! Berhasil memanaskan {success_count} dari {len(rows)} episode.")
    print("==================================================")
    print("💡 Anda sekarang bisa menjalankan 'Background Ingestion Worker' di GitHub Actions")

    ...
    <section className="mb-12 px-5 md:px-8 max-w-7xl mx-auto w-full">
              ...
              <button
                ...
                className={`shrink-0 px-4 py-2 rounded-full text-[13px] font-bold transition-all ${
                  isActive 
                    ...
                    : "bg-[#1c1c1e] text-[#8e8e93] hover:bg-white/10 hover:text-white"
                }`}
              >
                {day}
              </button>
      ...
      >
        {currentItems.map((item, idx) => (
          ...
          >
            <div className="w-full aspect-[2/3] bg-[#1c1c1e] rounded-xl overflow-hidden relative shadow-md mb-2 border border-white/5 group-hover:border-white/20 transition-all">
              {item.img ? (

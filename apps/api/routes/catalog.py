...
async def admin_export_swarm_vault_tg():
    ...
    try:
        ...
        writer.writerow(['id', 'anilistId', 'title', 'episodeNumber', 'providerId', 'episodeUrl', 'updatedAt'])
        for r in rows:
            writer.writerow([r['id'], r['anilistId'], r['title'] or 'Unknown', r['episodeNumber'], r['providerId'], r['episodeUrl'], r['updatedAt'].isoformat() if r['updatedAt'] else ''])
